      ...
      <div className="flex flex-col lg:grid grid-cols-3 gap-6 mt-4">
        { posts.length === 0 ? (
          ...
          posts.map((post: Post) => (
            <div 
              key={post._id} 
              className="border-4 border-gray-600 p-4 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 dark:border-gray-700 transform hover:-translate-y-2 relative overflow-hidden group"
            >
              <div>
